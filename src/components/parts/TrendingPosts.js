                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="news-post image-post">
                                ...
                                <div className="hover-post">
                                    ...
                                    <h2>
                                        <a href="single-post.html">Mountain View.</a>
                                    </h2>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="news-post standard-post left-align">
                                        ...
                                        <h2>
                                            <a href="single-post.html">Wide Vehicle Access.</a>
                                        </h2>
                                        <ul className="post-tags">
                                            <li>
                                ...
                                <div className="col-md-6">
                                    <div className="news-post standard-post left-align">
                                        ...
                                        <h2>
                                            <a href="single-post.html">Beach Activities.</a>
                                        </h2>
                                        <ul className="post-tags">
                                            <li>
                                                by <a href="#">Stan Enemy</a>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="news-post standard-post left-align">
                                        ...
                                        <h2>
                                            <a href="single-post.html">Wonderful Breakfast</a>
                                        </h2>
                                        <ul className="post-tags">
                                            <li>
                                                by <a href="#">Stan Enemy</a>
                                ...
                                <div className="col-md-6">
                                    <div className="news-post standard-post left-align">
                                        ...
                                        <h2>
                                            <a href="single-post.html">Better Sleep.</a>
                                        </h2>
                                        <ul className="post-tags">
                                            <li>
                                                by <a href="#">Stan Enemy</a>
